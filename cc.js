...
function Controller () {
    ...
    this.actions = {
        ...
        protect: { delay:    100, func: this.toggle_protect.bind(this) },

        main:    { delay:   100, func: Game.mouseCps },
        mainclick: { delay:   100, func: function () { bigCookie.click(); } },
        frenzy:  { delay:   100, func: function () { if (Game.buffs.Frenzy) this.bigCookie.click(); } },
        // season:  { delay: 1000, func: function () { if (Game.seasonPopup.life > 0) Game.seasonPopup.click(); } },
        gold:    { delay: 100, func: function () { if (Game.shimmers.length > 0) Game.shimmers[0].pop(); } },
...
view.ctrl.toggle_action('gold');
view.ctrl.toggle_action('frenzy');
